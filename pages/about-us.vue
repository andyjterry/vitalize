    ...
    <main class="isolate">
      ...
      <div class="mx-auto -mt-12 max-w-7xl px-6 sm:mt-0 lg:px-8 xl:-mt-8">
        <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
          ...
          <div class="sm:mt-6 flex flex-col gap-x-8 gap-y-10 lg:flex-row">
            <div class="lg:w-full lg:max-w-full lg:flex-auto ">
 
              <div class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 text-base leading-7 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                <div>
        ...
        <div class="text-gray-800 mt-10 sm:mt-0">
          ...
          >
            <li
              ...
              :key="person.name"
              class="flex flex-col gap-10 sm:flex-row sm:shadow-xl p-5 rounded-xl bg-gray-100/90 hover:bg-gray-100/80 transition duration-300 ease-in-out hover:shadow-none"
            >
              <img
...
import peopleData from "@/data/team.json";
import { Dialog, DialogPanel } from "@headlessui/vue";
import { Bars3Icon, XMarkIcon } from "@heroicons/vue/24/outline";

const values = ref(valuesData.values);
const people = ref(peopleData.staff);
</script>
